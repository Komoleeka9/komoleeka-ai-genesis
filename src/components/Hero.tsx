        ...
        <div className="flex justify-center">
          ...
          <div className="text-center max-w-4xl">
            ...
            >
              ...
              >
                Aspiring <TypewriterText texts={roles} className="text-foreground" />
              </motion.h2>
            </motion.div>
            
            <motion.p 
              className="font-roboto text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl leading-relaxed mx-auto"
